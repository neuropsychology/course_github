...
- Now, GitHub has become the largest open-source community extending far beyond programming
- It is structures in **repositories** (*repo*, for short), which is like a shared Dropbox folder, only more powerful.
<div class="centered">
...
<div class="centered">
![](img/workflow-github.png){width=60%} </div>
